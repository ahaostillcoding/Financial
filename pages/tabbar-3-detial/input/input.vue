<template>
	<view class="content">
		<uni-forms class="forms" ref="form" :modelValue="formData" :rules="rules">
			...
			<uni-forms-item label="分类:" name="tag">
				<uni-easyinput suffixIcon="search" type="text" v-model="formData.tag" @iconClick="addTag()" placeholder="请添加分类" />						
			</uni-forms-item>
	...
	export default {
		data() {
			return {
				...
				taglist: [{
						url: 'https://typoranote-picture.oss-cn-guangzhou.aliyuncs.com/typora图片/salary.png',
						text: '工资',
					},
					{
						url: 'https://typoranote-picture.oss-cn-guangzhou.aliyuncs.com/typora图片/financial.png',
						text: '理财',
					},
					{
						url: 'https://typoranote-picture.oss-cn-guangzhou.aliyuncs.com/typora图片/parttime.png',
						text: '兼职',
					},
					{
						url: 'https://typoranote-picture.oss-cn-guangzhou.aliyuncs.com/typora图片/gift.png',
						text: '礼金',
					},
					{
						url: 'https://typoranote-picture.oss-cn-guangzhou.aliyuncs.com/typora图片/other.png',
						text: '其他'
					}
				]
			}
		...
		methods: {
			...
			submit() {
				...
				db.collection("input").add(data)//获取数据表的信息
